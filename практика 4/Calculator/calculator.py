...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.hbox_zero.addWidget(self.b_plus)
        self.b_minus = QPushButton("-", self)
        self.hbox_zero.addWidget(self.b_minus)
        self.b_multipl = QPushButton("*", self)
        self.hbox_zero.addWidget(self.b_multipl)
        self.b_div = QPushButton("/", self)
        self.hbox_zero.addWidget(self.b_div)      
